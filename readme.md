...
As of Odyssey, controls are split into four top level categories:

1. [General controls](#general-controls)

2. [Ship controls](#ship-controls)

3. [SRV controls](#srv-controls)

4. [On foot controls](#on-foot-controls)

Note that each category can be assigned a different control scheme.
...
Same as [Ship controls/Mode switches](#mode-switches) section above.
